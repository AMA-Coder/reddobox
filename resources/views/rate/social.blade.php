  ...
  <div class="col-sm-6 col-md-3 my">
    <div class="thumbnail">
        ...
        <li id="menu">
            ...
            <li>
            <md-button href="/rate/personal/{{$user->id}}" class="md-raised md-primary mybtn" style="background-color:#272525;">
             Personal evaluation
          </md-button>
          </li>
          <li>
...
<hr>
    ...
    <center>
    <hr>
    	<md-button class="md-raised md-primary mybtn" ng-click="submit_social()" style="background-color: #1D7F8D">Reddo</md-button>
    </center>
      </div>
    </div>
</div>
