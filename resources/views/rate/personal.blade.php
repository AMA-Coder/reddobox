...
@if (Auth::user()->isFriendWith($user))
  ...
  <div class="col-sm-6 col-md-3 my">
    ...
    <center><h3><a href="/profile/{{$user->id}}">{{$user->fname}} {{$user->lname}}</h3></a></center>
        ...
        <li id="menu">
          <md-button href="/rate/personal/{{$user->id}}" class="md-raised md-primary activebtn" style="background-color:#1D7F8D;">
            personal evaluation
            </md-button>
            </li>
            <li>
...
<div class="col-md-9 col-sm-6"ng-controller="personalRateCtrl">
